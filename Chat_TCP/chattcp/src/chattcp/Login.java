...
public class Login extends JFrame {
	...
	public Login() {
		...
		JLabel lbDN = new JLabel("Login");
		lbDN.setForeground(new Color(0,128,128 ));
		...
		img.setIcon(new ImageIcon(new ImageIcon("D:\\my\\hang\\userlogin.png").getImage()
		...
		JButton btDN = new JButton("Login");
...
//		chckbxNewCheckBox.setBackground(getForeground());
		...
		JLabel lbCpr = new JLabel("@Hangnt.vku.udn.vn");
