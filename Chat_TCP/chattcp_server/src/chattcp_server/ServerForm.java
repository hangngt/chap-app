		...
		btStart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					lbO.setText("<html><font color='green'><b>SERVER Opening</b></font></html>");
		...
		btStop.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					lbO.setText("<html><font color='red'><b>SERVER Closed</b></font></html>");
...
//		txtUserOnl.setBackground(new Color(176, 224, 230));
		...
		lbO = new JLabel("SERVER Closed");
		panel_1.add(lbO);
		lbO.setForeground(new Color(0, 64, 0));
	...
	static void showUser() {
		...
		for (ChatSocket name : ServerThread.list) {
			txtUserOnl.append("No" + (count + 1) + " - " + name.getName() + " have joined the chat.\n");
			count++;
		}
	}
}
