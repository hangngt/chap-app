...
//		System.out.println(username + pass + repass);
	...
	public void doCreroom(StringTokenizer st) {
//		System.out.println("co thuc hien");
		String roomname = st.nextToken();
		ResultSet rs1 	= connec.roomsdisplay(roomname);

		// ------------- NOTIFICATION -------------
		String notif_1 = "Roomchat already exists!";
		String notif_2 = "Create Roomchat success!";
		String notif_3 = "Create Roomchat failed!";

		connec.newRoom(roomname);
		doSendData("CMD_CREROOM", notif_2);
	}
